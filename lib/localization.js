...
const LOCALIZATION = {
  FR: {
    ...
    texts: {
      ...
      upgradeDescription:
        "Les utilisateurs gratuits obtiennent 2 annonces par jour. Passez à la version supérieure pour obtenir jusqu'à des annonces quotidiennes illimitées, un support prioritaire et plus de fonctionnalités !",
      starterFeatures: "15 annonces/jour<br>Parfait pour vendeurs occasionnels",
  ...
  DE: {
    ...
    texts: {
      ...
      upgradeDescription:
        "Kostenlose Nutzer erhalten 2 Anzeigen pro Tag. Upgraden Sie, um bis zu unbegrenzte tägliche Anzeigen, Priority-Support und mehr Features zu erhalten!",
  ...
  PL: {
    ...
    texts: {
      ...
      upgradeDescription:
        "Darmowi użytkownicy otrzymują 2 ogłoszenia dziennie. Ulepsz, aby uzyskać nawet nieograniczoną liczbę ogłoszeń dziennie, priorytetowe wsparcie i więcej funkcji!",
      starterFeatures:
  ...
  ES: {
    ...
    texts: {
      ...
      upgradeDescription:
        "Los usuarios gratuitos obtienen 2 anuncios por día. ¡Actualiza para obtener hasta anuncios diarios ilimitados, soporte prioritario y más características!",
      starterFeatures:
  ...
  IT: {
    ...
    texts: {
      ...
      upgradeDescription:
        "Gli utenti gratuiti ottengono 2 annunci al giorno. Aggiorna per ottenere fino a annunci giornalieri illimitati, supporto prioritario e più funzionalità!",
      starterFeatures:
  ...
  NL: {
    ...
    texts: {
      ...
      upgradeDescription:
        "Gratis gebruikers krijgen 2 advertenties per dag. Upgrade om tot onbeperkte dagelijkse advertenties, prioriteitsondersteuning en meer functies te krijgen!",
      starterFeatures:
  ...
  DEFAULT: {
    ...
    texts: {
      ...
      upgradeDescription:
        "Free users get 2 listings per day. Upgrade to get up to unlimited daily listings, priority support, and more features!",
