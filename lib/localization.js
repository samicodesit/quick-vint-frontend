...
const LOCALIZATION = {
  FR: {
    ...
    texts: {
      ...
      feature3:
        "Flux de travail securise : generation de texte uniquement, sans actions de masse automatisees sur le compte",
      feature4: "Commencer avec 2 annonces gratuites par jour",
      upgradeTitle: "💡 Vous voulez plus de puissance ?",
      upgradeDescription:
        "Les utilisateurs gratuits ont 2 annonces par jour. Passez a une offre superieure pour plus d'annonces IA, un support prioritaire et plus de fonctionnalites !",
  ...
  DE: {
    ...
    texts: {
      ...
      upgradeDescription:
        "Kostenlose Nutzer erhalten 2 Anzeigen pro Tag. Upgraden Sie fur mehr KI-Listings, priorisierten Support und mehr Funktionen!",
  ...
  ES: {
    ...
    texts: {
      ...
      upgradeDescription:
        "Los usuarios gratuitos obtienen 2 anuncios por dia. Mejora tu plan para mas anuncios con IA, soporte prioritario y mas funciones!",
      starterFeatures:
  ...
  IT: {
    ...
    texts: {
      ...
      upgradeDescription:
        "Gli utenti gratuiti ottengono 2 annunci al giorno. Passa a un piano superiore per piu annunci IA, supporto prioritario e piu funzionalita!",
      starterFeatures:
  ...
  DEFAULT: {
    ...
    texts: {
      ...
      upgradeDescription:
        "Free users get 2 listings per day. Upgrade for more safe AI listings, priority support, and more features!",
