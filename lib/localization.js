...
const LOCALIZATION = {
  FR: {
    ...
    texts: {
      ...
      feature3: "Relisez chaque brouillon généré par l’IA avant publication",
  ...
  DE: {
    ...
    texts: {
      ...
      feature3: "Prüfe jeden KI-Entwurf vor der Veröffentlichung",
  ...
  PL: {
    ...
    texts: {
      ...
      feature3: "Sprawdź każdy szkic AI przed publikacją",
  ...
  ES: {
    ...
    texts: {
      ...
      feature3: "Revisa cada borrador generado por IA antes de publicarlo",
  ...
  IT: {
    ...
    texts: {
      ...
      feature3: "Controlla ogni bozza generata dall’AI prima di pubblicarla",
  ...
  NL: {
    ...
    texts: {
      ...
      feature3: "Controleer elk AI-concept voordat je het publiceert",
  ...
  DEFAULT: {
    ...
    texts: {
      ...
      feature3: "Review every AI draft before you publish",
...
LOCALIZATION.AU = {
  ...
  domain: "vinted.com.au",
  texts: {
    ...LOCALIZATION.DEFAULT.texts,
    vintedButton: "Start Creating on Vinted.com.au",
  },
};
...
function detectCountryAndLocalization() {
  ...
  if (navigator.language) {
    ...
    if (region === "AU") countryCode = "AU";
    else if (lang.startsWith("fr")) countryCode = "FR";
