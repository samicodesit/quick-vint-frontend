...
const LOCALIZATION = {
  FR: {
    ...
    texts: {
      ...
      upgradeDescription:
        "Les utilisateurs gratuits ont 2 annonces par jour. Passez à une offre supérieure pour plus d'annonces IA, un support prioritaire et plus de fonctionnalités !",
  ...
  DE: {
    ...
    texts: {
      ...
      upgradeDescription:
        "Kostenlose Nutzer erhalten 2 Anzeigen pro Tag. Upgraden Sie für mehr KI-Listings, priorisierten Support und mehr Funktionen!",
  ...
  DEFAULT: {
    ...
    texts: {
      ...
      upgradeDescription:
        "Free users get 5 lifetime listings. Upgrade for more safe AI listings, priority support, and more features!",
