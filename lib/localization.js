...
const LOCALIZATION = {
  FR: {
    ...
    texts: {
      ...
      feature4:
        "Démarrez avec 13 crédits gratuits — aucune carte requise",
  ...
  DE: {
    ...
    texts: {
      ...
      feature4:
        "Starte mit 13 kostenlosen Credits — keine Karte erforderlich",
  ...
  PL: {
    ...
    texts: {
      ...
      feature4:
        "Zacznij z 13 darmowymi kredytami — bez karty",
  ...
  ES: {
    ...
    texts: {
      ...
      feature4:
        "Comienza con 13 créditos gratis — sin tarjeta requerida",
  ...
  IT: {
    ...
    texts: {
      ...
      feature4:
        "Inizia con 13 crediti gratuiti — nessuna carta richiesta",
  ...
  NL: {
    ...
    texts: {
      ...
      feature4:
        "Begin met 13 gratis credits — geen kaart vereist",
  ...
  DEFAULT: {
    ...
    texts: {
      ...
      feature4:
        "Start with 13 free credits — no card required",
